...
const sun = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-sun"
                 viewBox="0 0 16 16">
    <path
...
const filledSun = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
...
const SidebarToggle = () => {
    ...
    const [isSunToggled, toggleSun] = useState(false);
    ...
    return (
        <div className={classes.sidebarToggle}>
            ...
            <Paper className={classes.sidebarToggleButton}
                   onClick={() => toggleSun(prevState => !prevState)}>
                {isSunToggled ? filledSun : sun}
            </Paper>
        </div>
    );
};
